...
export default function PrescricaoEnfermagemPrintTemplate({
    paciente,
    prescricao,
    internacao,
    itens,
        ...
        <div className="print-only" style={{
            ...
            <div style={{
                ...
                <div style={{ width: '300px', textAlign: 'center' }}>
                    <div style={{ borderTop: '1px solid #918282ff', marginBottom: '6px', width: '80%', margin: '0 auto' }}></div>
                    <p style={{ margin: '0 0 4px 0', fontWeight: '400', fontSize: '10pt', color: '#000' }}>
                        {medicoNome || 'Médico Responsável'}
                    </p>
                    <p style={{ margin: 0, color: '#000000ff', fontSize: '10pt' }}>
                        CRM: {medicoCRM || 'N/A'}
                    </p>
                </div>
            </div>
